...
public class MvcController {
	...
	*/
	...
	/*
	 	...
	 	CharaterEncodingFilter를 통해서 모든 요청마다 자동으로 UTF-8로 인코딩된다.
	...
	*/
	...
	/*
	 	@GetMapping("/detail.gdu")
		public String detailGdu(@ModelAttribut(value="p")Person p) { // Model에 저장할 속성명을 p로 해 주세요!
		return "mvc/detail";										 // detail.jsp ${p.name}, ${p.age}와 같은 형식으로 확인할 수 있다.
	}
	*/
